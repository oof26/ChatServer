...
public class ChatServer {
	...
	public void go() {
		...
		try {
			gui.addMessage("Server listening");
			while(running) {
				Socket s = in.accept();
				Client client = new Client(s);
				this.addNewClient(client);
				gui.addMessage("New client connected from: " + s.getPort() + " on port: " + in.getLocalPort() );
				/**
				 * 
	...
	/**
	 * Synchronized method to add newClient
	 * @param client
	 */
	private synchronized void addNewClient(Client client) {
